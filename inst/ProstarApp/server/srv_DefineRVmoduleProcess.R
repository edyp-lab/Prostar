rvModProcess <- reactiveValues(
    ...
    moduleFiltering = list(
        name = "Filtering",
        stepsNames = c(
            "Quanti. metadata filtering", "String-based filtering",
            "Numerical filtering", "Summary", "Save"
        ),
    ...
    moduleConvert = list(
        name = "Convert",
        stepsNames = c(
            "Select file", "Data Id", "Exp. & feat. data",
    ...
    moduleGO = list(
        name = "GO",
        stepsNames = c(
            "GO setup", "GO classification", "GO enrichment",
            "Parameter summary"
        ),
